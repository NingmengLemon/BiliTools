...
@export
def Danmaku2ASS(input_files, input_format, output_file, stage_width, stage_height, reserve_blank=0, font_face=_('(FONT) sans-serif')[7:], font_size=25.0, text_opacity=1.0, duration_marquee=5.0, duration_still=5.0, comment_filter=None, comment_filters=None, comment_filters_file=None, is_reduce_comments=False, progress_callback=None):
    if comment_filters and comment_filter:
        comment_filters.extend([comment_filter])
    elif comment_filters and not comment_filter:
        pass
    else:
